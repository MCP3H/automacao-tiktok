...
def salvarVideo(conexao, id_parametro, video_url, qt_frame, qt_frame_param, valid):
    executarQuery(conexao, f'INSERT INTO video (id_parametro, video_url, qt_frame, qt_frame_param, valid) VALUES ("{id_parametro}","{video_url}","{qt_frame}","{qt_frame_param}","{valid}")')